import 'package:bot_brain/controller/code_controller.dart';
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            PopupMenuButton<int>(
                              ...
                              onSelected: (value) {
                                if (value == 1) {
                                  controller.dataList.isNotEmpty ? Share.share("${controller.dataList.first.text}\n${controller.dataList.last.text}") : "";
                                } else if (value == 2) {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                "Our chatbot is ready to engage in a conversation with you. Start coding now and experience the power of AI",
                                style: GoogleFonts.interTight(
                                  textStyle: TextStyle(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return Container(
                                    ...
                                    width: MediaQuery.of(context).size.width,
                                    decoration: controller.dataList[index].isuser!
                                        ? const BoxDecoration()
                                        : BoxDecoration(
                                            color: ConstantColors.primary01,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        SvgPicture.asset(
                                          controller.dataList[index].isuser! ? "assets/icons/fill/User.svg" : "assets/images/logo_bot.svg",
                                          // ignore: deprecated_member_use
                                          color: controller.dataList[index].isuser! ? ConstantColors.primaryMain : null,
                                          width: 32,
                                        ),
                                        const SizedBox(
                                          width: 16,
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: TextFormField(
                        controller: controller.codeSearchController,
                    ...
                    InkWell(
                        onTap: () {
                          if (controller.codeSearchController.text.isEmpty) {
                            Get.snackbar(
